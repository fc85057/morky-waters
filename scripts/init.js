(() => {
  const adventureName = 'Mörky Waters';
  const moduleName = 'morky-waters';
   ...
   *   const creaturePacks = [];
   */
  const creaturePacks = [`${moduleName}.morky-waters-creatures`];
  /**
   ...
   *   const journalPacks = [];
   */
  const journalPacks = [`${moduleName}.morky-waters-notes`];
  /**
